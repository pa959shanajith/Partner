...
export const PROFILE = [
  {
    name: 'Update Profile',
    menuName: 'Update Profile',
    desc: 'Update Profile is where jobseeker add their job details',
    path: '/app/profile/update-profile/'
  },
  {
    name: 'Saved Profile',
    menuName: 'Saved Profile',
    desc: 'Saved Profile is where jobseeker view their job details',
    path: '/app/profile/saved-profile/'
  },
  {
    name: 'Profile Views',
    menuName: 'Profile Views',
    desc: 'Profile Views is where jobseeker view their job details',
    path: '/app/profile/profile-views/'
  }
...
export const JOBS = [
  {
    name: 'Saved Jobs',
    menuName: 'Saved Jobs',
    desc: 'Saved Jobs is where jobseeker add their job details',
    path: '/app/jobs/saved-jobs/'
  },
  {
    name: 'Search JObs',
    menuName: 'Search JObs',
    desc: 'Search JObs is where jobseeker view their job details',
    path: '/app/jobs/search-jobs/'
  },
  {
    name: 'Recommended Jobs',
    menuName: 'Recommended Jobs',
    desc: 'Recommended Jobs is where jobseeker view their job details',
    path: '/app/jobs/recommended-jobs/'
  }
]
