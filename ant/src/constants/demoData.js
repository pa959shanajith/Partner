const DEMO = {
  ...
  home: '#/app/dashboard',
  home2: '/app/dashboard',
  trainingpartnerdashboard:'/app/dashboard-tp',
  productLink: 'https://themeforest.net/item/ant-design-reactjs-admin-with-bootstrap/22194157',
  user: 'Lisa',
  login: '#/user/login',
  signUp: '#/user/sign-up',
  forgotPassword: '#/user/forgot-password',
  localUrl:"http://localhost:3000/#/user/login",
  stageUrl:"http://partner.stage.shenzyn.com/#/user/login",
  prodUrl:"http://partner.shenzyn.com/#/user/login"
}
...
DEMO.headerLink = {
  ...
  help: 'mailto:wehearyou@shenzyn.com?Subject=Help%20Required',
