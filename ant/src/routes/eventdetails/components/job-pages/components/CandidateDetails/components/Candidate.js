    ...
    componentDidMount() {
        ...
        if (this.props.formValidator)
            ...
            var data={
                    ...
                    "minexperience" : d.data.data.minexperience?Number(d.data.data.minexperience):Number(0),
                    "maxexperience" : d.data.data.maxexperience?Number(d.data.data.maxexperience):Number(0),
                    "industries": d.data.data.industries,
                    "functionalArea": d.data.data.functionalArea,
                    "noticePeriod": d.data.data.noticePeriod?Number(d.data.data.noticePeriod.replace(/['"]+/g, '')):Number(30),
