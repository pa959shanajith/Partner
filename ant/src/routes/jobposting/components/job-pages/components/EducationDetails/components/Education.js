    ...
    componentDidMount() {
        ...
        //console.log(d.data);
            var data={
                ...
                "qualification": d.data.data.educationalDetails[0].qualification,
                "specialization": d.data.data.educationalDetails[0].specialization, 
                "degree": d.data.data.educationalDetails[0].degree,
                "certificatesDesired":d.data.data.certificationRequired
            }
        ...
        this.partnerSvc.degrees().then((d) => {
            this.setState({ listOfDegrees: d.data, dupDegrees: d.data });
            this.state.loading = false;
        }).catch((err) => {
            console.log(err);
            this.state.loading = false;
                    ...
                    >
                        {getFieldDecorator(`qualification`, {
                            ...
                            <Select onChange={this.handleQualificationChange}>
                                ...
                                <Option value="Post Graduation">Administrative/Support</Option>
