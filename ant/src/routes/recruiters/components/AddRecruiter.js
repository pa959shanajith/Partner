            ...
            <div>
                ...
                >
                    <section className="form-v1-container pt-4">
                        <h3 style={{ fontSize: '28px', color: '#707070', fontWeight: '600' }}>Add/Update Recruiter</h3>
                        ...
                        >
                            ...
                            >
                                {getFieldDecorator(`mail`, {
                                    ...
                                    <Input autoComplete="email" disabled={isEdit} placeholder=" Email" onChange={e => this.handleOnChange(e, 'mail')} />
                                )}
                            </FormItem>
                            ...
                            <Form.Item {...tailLayout}>
                                <Button id="Partner_AddRecruiter_Submit" style={StyleSheet_DefaultButton} htmlType="submit" onClick={() => this.handleOk()}>
                                    Submit
                                </Button>
                            </Form.Item>
                        </Form>
...
const WrappedAddRecruiter = Form.create()(withRouter(AddRecruiter));
