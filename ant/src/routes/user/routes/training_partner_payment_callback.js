...
class training_partner_payment_callback extends React.Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount() {
        ...
        this.partnerService.getLastTrainingTransactions().then((res) =>{
...
export default withRouter(training_partner_payment_callback);